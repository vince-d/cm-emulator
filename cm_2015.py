...
bt = BTHelper([0.0 for x in xrange(576)], BLUETOOTH_FPS, window)
...
def on_draw():
	...
	if (floor):
		...
		shader_ground.shader.uniformi('time', time)
	...
	shader_body.shader.uniformi('do_light', lighting)
	shader_body.shader.uniformi('time', 0)
	...
	loc = glGetUniformLocation(shader_leds.shader.handle, "pixel")
	...
	shader_body.shader.uniformi('do_light', False)
	...
	shader_body.shader.uniformi('time', instruction_timer)
	...
	shader_body.shader.uniformi('time', time)
	...
	if (USE_POST_PROCESSING):
		...
		shader_pp.shader.uniformf('ratio_x', pixel_ratio_x)
		shader_pp.shader.uniformf('ratio_y', pixel_ratio_y)
		shader_pp.shader.uniformi('tex_width', gl.gl_x)
		shader_pp.shader.uniformi('tex_height', gl.gl_y)
		shader_pp.shader.uniformi('time', time)
...
shader_body.shader.bind()
shader_body.shader.uniformi('tex0', 0)
shader_body.shader.unbind()

shader_leds.shader.bind()
shader_leds.shader.uniformi('tex0', 0)
shader_leds.shader.unbind()

shader_ground.shader.bind()
shader_ground.shader.uniformi('tex0', 0)
shader_ground.shader.unbind()

shader_pp.shader.bind()
shader_pp.shader.uniformi('tex0', 0)
shader_pp.shader.unbind()
